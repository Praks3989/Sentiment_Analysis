...
public final class Constants {
    ...
    public static final String totalTweets = "TOTAL_TWEEETS";
    public static final String totalVocab = "VOCABULARY";
    public static final String positiveTweets = "TOTAL_POSITIVE_TWEETS";
    public static final String negativeTweets = "TOTAL_NEGATIVE_TWEETS";
    public static final String neutralTweets = "TOTAL_NEUTRAL_TWEETS";
    public static final String positiveWords = "TOTAL_POSITIVE_WORDS";
    public static final String negativeWords = "TOTAL_NEGATIVE_WORDS";
    public static final String neutralWords = "TOTAL_NEUTRAL_WORDS";
    ...
    public static final String userTweet = "USER_TWEET";
    public static final String[] stopWords = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all", "almost", "alone", "along", "already", "also", "although", "always", "am", "among",
